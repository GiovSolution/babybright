...
class C_master_jual_produk extends Controller {
	...
	function master_jual_produk_update(){
		...
		$result = $this->m_master_jual_produk->master_jual_produk_update($jproduk_id ,$jproduk_nobukti ,$jproduk_cust , $jproduk_tanggal
																		 ...
																		 ,$array_dproduk_diskon ,$array_dproduk_karyawan, $jproduk_grooming, $jual_kwitansi_id, $jual_kwitansi_id2, $jual_kwitansi_id3,$jproduk_nobukti_pajak);
		echo $result;
	}
	...
	function master_jual_produk_create(){
		...
		// Bagian untuk input Customer Baru
		$jproduk_cust_nama_baru=trim(@$_POST["jproduk_cust_nama_baru"]);
		$jproduk_cust_nama_baru=str_replace("/(<\/?)(p)([^>]*>)", "",$jproduk_cust_nama_baru);
		$jproduk_cust_nama_baru=str_replace("'", "''",$jproduk_cust_nama_baru);
		$jproduk_cust_telp_baru=trim(@$_POST["jproduk_cust_telp_baru"]);
		$jproduk_cust_telp_baru=str_replace("/(<\/?)(p)([^>]*>)", "",$jproduk_cust_telp_baru);
		$jproduk_cust_telp_baru=str_replace("'", "''",$jproduk_cust_telp_baru);
		$jproduk_cust_hp_baru=trim(@$_POST["jproduk_cust_hp_baru"]);
		$jproduk_cust_hp_baru=str_replace("/(<\/?)(p)([^>]*>)", "",$jproduk_cust_hp_baru);
		$jproduk_cust_hp_baru=str_replace("'", "''",$jproduk_cust_hp_baru);
		$jproduk_cust_keterangan_baru=trim(@$_POST["jproduk_cust_keterangan_baru"]);
		$jproduk_cust_keterangan_baru=str_replace("/(<\/?)(p)([^>]*>)", "",$jproduk_cust_keterangan_baru);
		$jproduk_cust_keterangan_baru=str_replace("'", "''",$jproduk_cust_keterangan_baru);
		...
		$result=$this->m_master_jual_produk->master_jual_produk_create($jproduk_nobukti ,$jproduk_cust ,$jproduk_tanggal
																	   ...
																	   ,$array_dproduk_id ,$array_dproduk_produk ,$array_dproduk_satuan
																	   ,$array_dproduk_jumlah ,$array_dproduk_harga ,$array_dproduk_diskon_jenis
																	   ,$array_dproduk_diskon ,$array_dproduk_karyawan, $jproduk_grooming, $jual_kwitansi_id, $jual_kwitansi_id2, $jual_kwitansi_id3,$jproduk_cust_nama_baru,$jproduk_cust_telp_baru,$jproduk_cust_hp_baru,$jproduk_cust_keterangan_baru);
		echo $result;
	}
