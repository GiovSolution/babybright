...
class C_aset_group extends Controller {
	...
	function group_aset_update(){
		...
		$group_aset_lokasi=trim(@$_POST["group_aset_lokasi"]);
		$group_aset_lokasi=str_replace("/(<\/?)(p)([^>]*>)", "",$group_aset_lokasi);
		$group_aset_lokasi=str_replace("'", '"',$group_aset_lokasi);
		...
		$group_aset_tanggal=trim(@$_POST["group_aset_tanggal"]);
		$group_aset_tanggal=str_replace("/(<\/?)(p)([^>]*>)", "",$group_aset_tanggal);
		$group_aset_tanggal=str_replace("'", '"',$group_aset_tanggal);
		...
		*/
		$result = $this->m_aset_group->group_aset_update($group_aset_id ,$group_aset_kode ,$group_aset_nama ,$group_aset_lokasi ,$group_aset_kelas, $group_aset_tanggal ,$group_aset_usia, $group_aset_keterangan, $group_aset_aktif);
		echo $result;
	}
	...
	function group_aset_create(){
		...
		$gudang_revised=trim(@$_POST["gudang_revised"]);
		*/
		$result=$this->m_aset_group->group_aset_create($group_aset_kode ,$group_aset_nama ,$group_aset_lokasi ,$group_aset_kelas, $group_aset_tanggal ,$group_aset_usia, $group_aset_keterangan, $group_aset_aktif); //$gudang_creator ,$gudang_date_create ,$gudang_update ,$gudang_date_update ,$gudang_revised );
		echo $result;
	}
