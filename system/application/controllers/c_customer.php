...
class C_customer extends Controller {
	...
	function customer_update(){
		...
		$cust_nama=str_replace("/(<\/?)(p)([^>]*>)", "",$cust_nama);
		$cust_nama=str_replace("'", '"',$cust_nama);
		$cust_image=trim(@$_POST["cust_image"]);
		...
		$cust_alamat2=str_replace("/(<\/?)(p)([^>]*>)", "",$cust_alamat2);
		$cust_alamat2=str_replace("'", '"',$cust_alamat2);		
		$cust_kewarganegaraan=trim(@$_POST["cust_kewarganegaraan"]);
		$cust_kewarganegaraan=str_replace("/(<\/?)(p)([^>]*>)", "",$cust_kewarganegaraan);
		$cust_kewarganegaraan=str_replace("'", '"',$cust_kewarganegaraan);
		...
		$cust_ayah_nama=trim(@$_POST["cust_ayah_nama"]);
		$cust_ayah_nama=str_replace("/(<\/?)(p)([^>]*>)", "",$cust_ayah_nama);
		$cust_ayah_nama=str_replace("'", '"',$cust_ayah_nama);
		$cust_ayah_tempat_lahir=trim(@$_POST["cust_ayah_tempat_lahir"]);
		$cust_ayah_tempat_lahir=str_replace("/(<\/?)(p)([^>]*>)", "",$cust_ayah_tempat_lahir);
		$cust_ayah_tempat_lahir=str_replace("'", '"',$cust_ayah_tempat_lahir);
		$cust_ayah_tanggal_lahir=trim(@$_POST["cust_ayah_tanggal_lahir"]);
		$cust_ayah_agama=trim(@$_POST["cust_ayah_agama"]);
		$cust_ayah_agama=str_replace("/(<\/?)(p)([^>]*>)", "",$cust_ayah_agama);
		$cust_ayah_agama=str_replace("'", '"',$cust_ayah_agama);
		$cust_ayah_kewarganegaraan=trim(@$_POST["cust_ayah_kewarganegaraan"]);
		$cust_ayah_kewarganegaraan=str_replace("/(<\/?)(p)([^>]*>)", "",$cust_ayah_kewarganegaraan);
		$cust_ayah_kewarganegaraan=str_replace("'", '"',$cust_ayah_kewarganegaraan);
		$cust_ayah_telp=trim(@$_POST["cust_ayah_telp"]);
		$cust_ayah_telp=str_replace("/(<\/?)(p)([^>]*>)", "",$cust_ayah_telp);
		$cust_ayah_telp=str_replace("'", '"',$cust_ayah_telp);
		$cust_ayah_hp=trim(@$_POST["cust_ayah_hp"]);
		$cust_ayah_hp=str_replace("/(<\/?)(p)([^>]*>)", "",$cust_ayah_hp);
		$cust_ayah_hp=str_replace("'", '"',$cust_ayah_hp);
		$cust_ayah_alamat=trim(@$_POST["cust_ayah_alamat"]);
		$cust_ayah_alamat=str_replace("/(<\/?)(p)([^>]*>)", "",$cust_ayah_alamat);
		$cust_ayah_alamat=str_replace("'", '"',$cust_ayah_alamat);
		$cust_ayah_alamat_kantor=trim(@$_POST["cust_ayah_alamat_kantor"]);
		$cust_ayah_alamat_kantor=str_replace("/(<\/?)(p)([^>]*>)", "",$cust_ayah_alamat_kantor);
		$cust_ayah_alamat_kantor=str_replace("'", '"',$cust_ayah_alamat_kantor);
		$cust_ayah_telp_kantor=trim(@$_POST["cust_ayah_telp_kantor"]);
		$cust_ayah_telp_kantor=str_replace("/(<\/?)(p)([^>]*>)", "",$cust_ayah_telp_kantor);
		$cust_ayah_telp_kantor=str_replace("'", '"',$cust_ayah_telp_kantor);
		$cust_ayah_email=trim(@$_POST["cust_ayah_email"]);
		$cust_ayah_email=str_replace("/(<\/?)(p)([^>]*>)", "",$cust_ayah_email);
		$cust_ayah_email=str_replace("'", '"',$cust_ayah_email);
		$cust_ayah_bb=trim(@$_POST["cust_ayah_bb"]);
		$cust_ayah_bb=str_replace("/(<\/?)(p)([^>]*>)", "",$cust_ayah_bb);
		$cust_ayah_bb=str_replace("'", '"',$cust_ayah_bb);
		
		$cust_ibu_nama=trim(@$_POST["cust_ibu_nama"]);
		$cust_ibu_nama=str_replace("/(<\/?)(p)([^>]*>)", "",$cust_ibu_nama);
		$cust_ibu_nama=str_replace("'", '"',$cust_ibu_nama);
		$cust_ibu_tempat_lahir=trim(@$_POST["cust_ibu_tempat_lahir"]);
		$cust_ibu_tempat_lahir=str_replace("/(<\/?)(p)([^>]*>)", "",$cust_ibu_tempat_lahir);
		$cust_ibu_tempat_lahir=str_replace("'", '"',$cust_ibu_tempat_lahir);
		$cust_ibu_tanggal_lahir=trim(@$_POST["cust_ibu_tanggal_lahir"]);
		$cust_ibu_agama=trim(@$_POST["cust_ibu_agama"]);
		$cust_ibu_agama=str_replace("/(<\/?)(p)([^>]*>)", "",$cust_ibu_agama);
		$cust_ibu_agama=str_replace("'", '"',$cust_ibu_agama);
		$cust_ibu_kewarganegaraan=trim(@$_POST["cust_ibu_kewarganegaraan"]);
		$cust_ibu_kewarganegaraan=str_replace("/(<\/?)(p)([^>]*>)", "",$cust_ibu_kewarganegaraan);
		$cust_ibu_kewarganegaraan=str_replace("'", '"',$cust_ibu_kewarganegaraan);
		$cust_ibu_telp=trim(@$_POST["cust_ibu_telp"]);
		$cust_ibu_telp=str_replace("/(<\/?)(p)([^>]*>)", "",$cust_ibu_telp);
		$cust_ibu_telp=str_replace("'", '"',$cust_ibu_telp);
		$cust_ibu_hp=trim(@$_POST["cust_ibu_hp"]);
		$cust_ibu_hp=str_replace("/(<\/?)(p)([^>]*>)", "",$cust_ibu_hp);
		$cust_ibu_hp=str_replace("'", '"',$cust_ibu_hp);
		$cust_ibu_alamat=trim(@$_POST["cust_ibu_alamat"]);
		$cust_ibu_alamat=str_replace("/(<\/?)(p)([^>]*>)", "",$cust_ibu_alamat);
		$cust_ibu_alamat=str_replace("'", '"',$cust_ibu_alamat);
		$cust_ibu_alamat_kantor=trim(@$_POST["cust_ibu_alamat_kantor"]);
		$cust_ibu_alamat_kantor=str_replace("/(<\/?)(p)([^>]*>)", "",$cust_ibu_alamat_kantor);
		$cust_ibu_alamat_kantor=str_replace("'", '"',$cust_ibu_alamat_kantor);
		$cust_ibu_telp_kantor=trim(@$_POST["cust_ibu_telp_kantor"]);
		$cust_ibu_telp_kantor=str_replace("/(<\/?)(p)([^>]*>)", "",$cust_ibu_telp_kantor);
		$cust_ibu_telp_kantor=str_replace("'", '"',$cust_ibu_telp_kantor);
		$cust_ibu_email=trim(@$_POST["cust_ibu_email"]);
		$cust_ibu_email=str_replace("/(<\/?)(p)([^>]*>)", "",$cust_ibu_email);
		$cust_ibu_email=str_replace("'", '"',$cust_ibu_email);
		$cust_ibu_bb=trim(@$_POST["cust_ibu_bb"]);
		$cust_ibu_bb=str_replace("/(<\/?)(p)([^>]*>)", "",$cust_ibu_bb);
		$cust_ibu_bb=str_replace("'", '"',$cust_ibu_bb);

		//Data Pengantar
		$cust_nama_pengantar1=trim(@$_POST["cust_nama_pengantar1"]);
		$cust_nama_pengantar1=str_replace("/(<\/?)(p)([^>]*>)", "",$cust_nama_pengantar1);
		$cust_nama_pengantar1=str_replace("'", '"',$cust_nama_pengantar1);

		$cust_nama_pengantar2=trim(@$_POST["cust_nama_pengantar2"]);
		$cust_nama_pengantar2=str_replace("/(<\/?)(p)([^>]*>)", "",$cust_nama_pengantar2);
		$cust_nama_pengantar2=str_replace("'", '"',$cust_nama_pengantar2);

		$cust_nama_pengantar3=trim(@$_POST["cust_nama_pengantar3"]);
		$cust_nama_pengantar3=str_replace("/(<\/?)(p)([^>]*>)", "",$cust_nama_pengantar3);
		$cust_nama_pengantar3=str_replace("'", '"',$cust_nama_pengantar3);

		$cust_nama_pengantar4=trim(@$_POST["cust_nama_pengantar4"]);
		$cust_nama_pengantar4=str_replace("/(<\/?)(p)([^>]*>)", "",$cust_nama_pengantar4);
		$cust_nama_pengantar4=str_replace("'", '"',$cust_nama_pengantar4);

		$cust_nama_pengantar5=trim(@$_POST["cust_nama_pengantar5"]);
		$cust_nama_pengantar5=str_replace("/(<\/?)(p)([^>]*>)", "",$cust_nama_pengantar5);
		$cust_nama_pengantar5=str_replace("'", '"',$cust_nama_pengantar5);

		$cust_hub_pengantar1=trim(@$_POST["cust_hub_pengantar1"]);
		$cust_hub_pengantar1=str_replace("/(<\/?)(p)([^>]*>)", "",$cust_hub_pengantar1);
		$cust_hub_pengantar1=str_replace("'", '"',$cust_hub_pengantar1);

		$cust_hub_pengantar2=trim(@$_POST["cust_hub_pengantar2"]);
		$cust_hub_pengantar2=str_replace("/(<\/?)(p)([^>]*>)", "",$cust_hub_pengantar2);
		$cust_hub_pengantar2=str_replace("'", '"',$cust_hub_pengantar2);

		$cust_hub_pengantar3=trim(@$_POST["cust_hub_pengantar3"]);
		$cust_hub_pengantar3=str_replace("/(<\/?)(p)([^>]*>)", "",$cust_hub_pengantar3);
		$cust_hub_pengantar3=str_replace("'", '"',$cust_hub_pengantar3);

		$cust_hub_pengantar4=trim(@$_POST["cust_hub_pengantar4"]);
		$cust_hub_pengantar4=str_replace("/(<\/?)(p)([^>]*>)", "",$cust_hub_pengantar4);
		$cust_hub_pengantar4=str_replace("'", '"',$cust_hub_pengantar4);

		$cust_hub_pengantar5=trim(@$_POST["cust_hub_pengantar5"]);
		$cust_hub_pengantar5=str_replace("/(<\/?)(p)([^>]*>)", "",$cust_hub_pengantar5);
		$cust_hub_pengantar5=str_replace("'", '"',$cust_hub_pengantar5);

		$cust_telp_pengantar1=trim(@$_POST["cust_telp_pengantar1"]);
		$cust_telp_pengantar1=str_replace("/(<\/?)(p)([^>]*>)", "",$cust_telp_pengantar1);
		$cust_telp_pengantar1=str_replace("'", '"',$cust_telp_pengantar1);

		$cust_telp_pengantar2=trim(@$_POST["cust_telp_pengantar2"]);
		$cust_telp_pengantar2=str_replace("/(<\/?)(p)([^>]*>)", "",$cust_telp_pengantar2);
		$cust_telp_pengantar2=str_replace("'", '"',$cust_telp_pengantar2);

		$cust_telp_pengantar3=trim(@$_POST["cust_telp_pengantar3"]);
		$cust_telp_pengantar3=str_replace("/(<\/?)(p)([^>]*>)", "",$cust_telp_pengantar3);
		$cust_telp_pengantar3=str_replace("'", '"',$cust_telp_pengantar3);

		$cust_telp_pengantar4=trim(@$_POST["cust_telp_pengantar4"]);
		$cust_telp_pengantar4=str_replace("/(<\/?)(p)([^>]*>)", "",$cust_telp_pengantar4);
		$cust_telp_pengantar4=str_replace("'", '"',$cust_telp_pengantar4);

		$cust_telp_pengantar5=trim(@$_POST["cust_telp_pengantar5"]);
		$cust_telp_pengantar5=str_replace("/(<\/?)(p)([^>]*>)", "",$cust_telp_pengantar5);
		$cust_telp_pengantar5=str_replace("'", '"',$cust_telp_pengantar5);

		$cust_image_pengantar1=trim(@$_POST["cust_image_pengantar1"]);
		$cust_image_pengantar2=trim(@$_POST["cust_image_pengantar2"]);
		$cust_image_pengantar3=trim(@$_POST["cust_image_pengantar3"]);
		$cust_image_pengantar4=trim(@$_POST["cust_image_pengantar4"]);
		$cust_image_pengantar5=trim(@$_POST["cust_image_pengantar5"]);

		$result = $this->m_customer->customer_update($cust_id ,$cust_no ,$cust_nolama ,$cust_nama, $cust_image, $cust_title, $cust_panggilan, $cust_foreigner ,$cust_kelamin ,$cust_alamat ,$cust_kota ,$cust_kodepos ,$cust_propinsi ,$cust_negara,$cust_alamat2,$cust_kewarganegaraan ,$cust_kota2 ,$cust_kodepos2 ,$cust_propinsi2 ,$cust_negara2 ,$cust_telprumah ,$cust_telprumah2 ,$cust_telpkantor ,$cust_hp ,$cust_hp2 ,$cust_hp3 ,$cust_email ,$cust_fb ,$cust_tweeter , $cust_email2 ,$cust_fb2 ,$cust_tweeter2 ,$cust_agama ,$cust_pendidikan ,$cust_profesi ,$cust_tmptlahir ,$cust_tgllahir ,$cust_referensi, $cust_referensilain ,$cust_keterangan ,$cust_member ,$cust_terdaftar ,$cust_tglawaltrans, $cust_statusnikah , /*$cust_priority , */$cust_jmlanak ,$cust_unit ,$cust_aktif , $cust_fretfulness, $cust_creator ,$cust_date_create ,$cust_update ,$cust_date_update ,$cust_revised ,$cust_cp ,$cust_cptelp, $cust_hobi_baca, $cust_hobi_olah, $cust_hobi_masak, $cust_hobi_travel, $cust_hobi_foto, $cust_hobi_lukis, $cust_hobi_nari, $cust_hobi_lain, $cust_bb, 
			$cust_nama_pengantar1, $cust_nama_pengantar2, $cust_nama_pengantar3, $cust_nama_pengantar4, $cust_nama_pengantar5, 
			$cust_hub_pengantar1, $cust_hub_pengantar2, $cust_hub_pengantar3, $cust_hub_pengantar4, $cust_hub_pengantar5, 
			$cust_telp_pengantar1, $cust_telp_pengantar2, $cust_telp_pengantar3, $cust_telp_pengantar4, $cust_telp_pengantar5,
			$cust_image_pengantar1, $cust_image_pengantar2, $cust_image_pengantar3, $cust_image_pengantar4, $cust_image_pengantar5,
			
			$cust_ayah_nama, $cust_ayah_tempat_lahir, $cust_ayah_tanggal_lahir, $cust_ayah_agama, $cust_ayah_kewarganegaraan, $cust_ayah_telp, $cust_ayah_hp, 
			$cust_ayah_alamat, $cust_ayah_alamat_kantor, $cust_ayah_telp_kantor, $cust_ayah_email, $cust_ayah_bb,

			$cust_ibu_nama, $cust_ibu_tempat_lahir, $cust_ibu_tanggal_lahir, $cust_ibu_agama, $cust_ibu_kewarganegaraan, $cust_ibu_telp, $cust_ibu_hp, 
			$cust_ibu_alamat, $cust_ibu_alamat_kantor, $cust_ibu_telp_kantor, $cust_ibu_email, $cust_ibu_bb
			 );
		echo $result;
	}
	...
	function customer_create(){
		...
		$cust_kewarganegaraan=str_replace("/(<\/?)(p)([^>]*>)", "",$cust_kewarganegaraan);
		$cust_kewarganegaraan=str_replace("'", '"',$cust_kewarganegaraan);
		$cust_kelurahan=trim(@$_POST["cust_kelurahan"]);
		$cust_kelurahan=str_replace("/(<\/?)(p)([^>]*>)", "",$cust_kelurahan);
		$cust_kelurahan=str_replace("'", '"',$cust_kelurahan);
		$cust_kecamatan=trim(@$_POST["cust_kecamatan"]);
		$cust_kecamatan=str_replace("/(<\/?)(p)([^>]*>)", "",$cust_kecamatan);
		$cust_kecamatan=str_replace("'", '"',$cust_kecamatan);
		$cust_kotamadya=trim(@$_POST["cust_kotamadya"]);
		$cust_kotamadya=str_replace("/(<\/?)(p)([^>]*>)", "",$cust_kotamadya);
		$cust_kotamadya=str_replace("'", '"',$cust_kotamadya);
		$cust_tgllahir=trim(@$_POST["cust_tgllahir"]);
		//$cust_tgllahirend=trim(@$_POST["cust_tgllahirend"]);
		$cust_hobitxt=trim(@$_POST["cust_hobitxt"]);
		$cust_hobitxt=str_replace("/(<\/?)(p)([^>]*>)", "",$cust_hobitxt);
