...
class M_aset_group extends Model{
		...
		function group_aset_update($group_aset_id ,$group_aset_kode ,$group_aset_nama ,$group_aset_lokasi ,$group_aset_kelas ,$group_aset_tanggal ,$group_aset_usia, $group_aset_keterangan, $group_aset_aktif){
			if ($group_aset_aktif=="")
			...
			$data = array(
				...
				"aset_grup_lokasi"=>$group_aset_lokasi,	
				"aset_grup_kelas"=>$group_aset_kelas,	
				"aset_grup_tanggal"=>$group_aset_tanggal,
		...
		function group_aset_create($group_aset_kode ,$group_aset_nama ,$group_aset_lokasi ,$group_aset_kelas, $group_aset_tanggal ,$group_aset_usia, $group_aset_keterangan, $group_aset_aktif){
			if ($group_aset_aktif=="")
				$group_aset_aktif = "Aktif";
			$data = array(
