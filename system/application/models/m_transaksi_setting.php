...
class M_transaksi_setting extends Model{
		...
		function transaksi_setting_update($trans_op_days, $mb_days, $kembali_poin_days, $uang_pangkal_enrichment, $uang_sekolah_enrichment, $trans_update, $trans_date_update){
			$data = array(				
				"trans_op_days"=>$trans_op_days,
				"mb_days"=>$mb_days,				
