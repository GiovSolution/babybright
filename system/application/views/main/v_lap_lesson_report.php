  ...
  Ext.QuickTips.init();
	...
	custDataStore = new Ext.data.Store({
		...
		proxy: new Ext.data.HttpProxy({
			url: 'index.php?c=c_lap_lesson_report&m=get_customer_list', 
			method: 'POST'
		}),
		...
		Ext.MessageBox.show({
		   ...
		   wait:true
			...
			Ext.Ajax.request({   
				waitMsg: 'Please Wait...',
				timeout: 3600000,
				url: 'index.php?c=c_lap_lesson_report&m=print_laporan',
				params: {
	...
	rpt_piutangWindow = new Ext.Window({
		...
		y: 0,
		modal: true,
		renderTo: 'elwindow_lap_lesson_report',
...
<div>
	<div class="col">
        <div id="fp_info"></div>
		<div id="elwindow_lap_lesson_report"></div>
    </div>
</div>
</body>