...
Ext.onReady(function(){
	...
	cbo_rawat_groupDataStore = new Ext.data.Store({
		...
		/* dataIndex => insert intocustomer_note_ColumnModel, Mapping => for initiate table column */ 
			{name: 'rawat_group_value', type: 'int', mapping: 'kategori_id'},
			{name: 'rawat_group_display', type: 'string', mapping: 'kategori_nama'},
		...
		items:[
			{
			...
			},
			 {
					...
					labelWidth: 80,
					labelAlign: 'left',
					items:[/*rawat_aktif_kutaField, rawat_aktif_btmField, rawat_aktif_mksField, rawat_aktif_mdnField, rawat_aktif_lbkField, rawat_aktif_mndField, rawat_aktif_ygkField, rawat_aktif_jktField, rawat_aktif_smgField*/]
			   }
		]
	});	
		...
		items:[
			{
				...
				layout: 'form',
				border:false,
				items: [rawat_kodelamaField, rawat_kodeField, rawat_namaField, rawat_highmarginField, rawat_edit_hargaField, rawat_jenisField, rawat_hargaField, rawat_harga_checkField, rawat_kategoritxtField, rawat_hargaGroup] 
			}
			,{
				columnWidth:0.5,
				layout: 'form',
				...
				<? } ?>
				rawat_kontribusiField, rawat_gudangField, rawat_keteranganField,  rawat_idField, rawat_aktifGroup /*, rawat_diskonGroup*/] 
			}
			]
