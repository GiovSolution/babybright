...
Ext.onReady(function(){
	...
	function kategori_create(){
		...
		if(kategori_grupField.getValue()!== null){kategori_grup_create = kategori_grupField.getValue();}
		if(kategori_aktifField.getValue()!== null){kategori_aktif_create = kategori_aktifField.getValue();}
			...
			Ext.Ajax.request({  
				...
				params: {
					...
					kategori_grup			: kategori_grup_create,
	...
	function kategori_set_form(){
		...
		kategori_grupField.setValue(kategoriListEditorGrid.getSelectionModel().getSelected().get('kategori_grup'));
	...
	kategori_DataStore = new Ext.data.Store({
		...
		reader: new Ext.data.JsonReader({
			...
			{name: 'kategori_grup', type: 'string', mapping: 'kategori_grup'},
		...
		*/
		...
		},
		{
			...
			editor: new Ext.form.ComboBox({
				...
				triggerAction: 'all',
				store:new Ext.data.SimpleStore({
					fields:['kategori_grup_value', 'kategori_grup_display'],
					data: [['Produk','Produk'],['Perawatan/Paket','Perawatan/Paket']]
					}),
				mode: 'local',
               	displayField: 'kategori_grup_display',
               	valueField: 'kategori_grup_value',
               	lazyRender:true,
               	listClass: 'x-combo-list-small',
				anchor: '30%'
            })
	...
	/* Identify  kategori_grup Field */
	kategori_grupField= new Ext.form.ComboBox({
		id: 'kategori_grupField',
		name: 'kategori_grupField',
		fieldLabel: 'Grup Aktif',
		editable: false,
		store:new Ext.data.SimpleStore({
			fields:['kategori_grup_value', 'kategori_grup_display'],
			data:[['Produk','Produk'],['Perawatan/Paket','Perawatan/Paket']]
	...
	kategori_createForm = new Ext.FormPanel({
		...
		items: [{
			...
			items:[
			{
				...
				layout: 'form',
				border:false,
				items: [kategori_namaField, kategori_kodeField,  /* kategori_kategoriField, */ kategori_keteranganField, kategori_grupField, kategori_aktifField] 
			}
			]
		}]
		,
