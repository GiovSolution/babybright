...
<head>
	...
	<title>Laporan Detail Penjualan <?php echo $jenis; ?> <?php echo $periode; ?> Group By <?php echo $group; ?> </title>
	<link rel='stylesheet' type='text/css' href='../assets/modules/main/css/printstyle.css'/>
</head>
<body onload="window.print();">
<table summary='Detail Jual'>
<caption>Laporan Detail Penjualan <?php echo $jenis; ?><br/><?php echo $periode; ?> <br/>Group By <?php echo $group; ?>, Opsi by <?php echo $opsi; ?></caption>
<thead> 
	<tr> 
		<?//<td scope='col'></td>?>
		<th scope='col'>No</th>
...
<?php 
	...
	foreach($data_print as $print) { ?><?php 
		if($faktur!==$print->no_bukti) { 
			...
			$total_hutang+=$print->bayar-$print->totalbiaya;
			// total cara bayar
			...
			if ($print->keterangan == ''){ 
				...
				?>
						...
						<tr> 
							...
							<td align="right" class="numeric"><b>Potongan (Rp)</b></td> 
						...
						<tr> 
							...
							<td align="right" class="numeric">&nbsp;</td> 
							<td align="right" class="numeric">&nbsp;</td> 
							<td align="right" class="numeric"><b>Kembalian (Rp)</b></td> 
							<td align="right" class="numeric"><b><?php echo number_format($print->bayar-$print->totalbiaya,0,",",","); ?></b></td> 
...
<tr> 
	<?//<td></td>?>
	<td class="foot">&nbsp;</td> 
	<th scope='row' nowrap="nowrap">Total Potongan (Rp)</th> 
...
<tr> 
	<?//<td></td>?>
	<td class="foot">&nbsp;</td> 
	<th scope='row' nowrap="nowrap">Total Kembalian (Rp)</th> 
